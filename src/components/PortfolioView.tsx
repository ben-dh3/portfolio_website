...
const PortfolioView = () => {
  ...
  return (
    <div ref={projectsRef} className="bg-black text-white flex flex-col md:flex-row justify-evenly min-h-screen w-full">
      ...
      <div className='flex-1 grid grid-cols-1'>
        <Link to="/balancednews" className="m-8 project">
          <ProjectView image="/projects/balancednews/Headlines Page.webp" title="Balanced News PWA" description="AWS Lambda, DynamoDB, API Gateway, Amplify, Typescript, React" />
        </Link>
